...
/**
 * inorder_successor - Retur  ns the minimum value of a binary search tree.
...
/**
 * bst_delete - Dele  tes a node from a binary search tree.
 * @root: A pointer to the root node of the BST.
 * @node: A poin  ter to the node to delete from the BST.
 *
